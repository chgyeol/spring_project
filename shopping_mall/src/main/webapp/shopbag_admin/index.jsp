    ...
    <section class="admin_bgcolor">
        <div class="admin_login">
            <span>
                <div class="left_div">
                <ul>
                <li><input type="text" class="input_text1" placeholder="관리자 아이디를 입력하세요" name="aid"></li>
                <li><input type="password" class="input_text1" placeholder="관리자 패스워드를 입력하세요" name="apass"></li>
                </ul>
                </div>
                <div class="right_div">
            ...
            <span>
                <ol class="admin_info">
                    <li title="신규 관리자 등록요청" onclick="add_master_req()">신규 관리자 등록요청</li>
                    <li title="아이디/패스워드 찾기" onclick="find_admin_idpw()">아이디/패스워드 찾기</li>
                </ol>                
            </span>
        </div>
    </section>
